(function (global, factory) {
	...
	function readResAsString(response, autoDetectCharset) {
	  ...
	  if (parts.length === 2) {
	    var _parts$1$split = parts[1].split('='),
	        _parts$1$split2 = slicedToArray(_parts$1$split, 2),
	    ...
	    setGlobalState: function setGlobalState() {
	      ...
	      globalState = cloneDeep_1(Object.keys(state).reduce(function (_globalState, changeKey) {
	        if (isMaster || _globalState.hasOwnProperty(changeKey)) {
	          ...
	          return Object.assign(_globalState, defineProperty({}, changeKey, state[changeKey]));
	        }
	...
	function setWindowProp(prop, value, toDelete) {
	  if (value === undefined && toDelete) {
	    delete window[prop];
	  } else if (isPropConfigurable(window, prop) && _typeof_1(prop) !== 'symbol') {
	...
	var SingularProxySandbox = /*#__PURE__*/function () {
	  function SingularProxySandbox(name) {
	    ...
	    classCallCheck(this, SingularProxySandbox);
	  ...
	  createClass(SingularProxySandbox, [{
	    key: "active",
	    ...
	    value: function inactive() {
	      {
	        console.info("[qiankun:sandbox] ".concat(this.name, " modified global properties restore..."), [].concat(toConsumableArray(this.addedPropsMapInSandbox.keys()), toConsumableArray(this.modifiedPropsOriginalValueMapInSandbox.keys())));
	...
	function patch$1(global) {
	  ...
	  global.setInterval = function (handler, timeout) {
	    ...
	    intervals = [].concat(toConsumableArray(intervals), [intervalId]);
	    return intervalId;
	  };
	...
	function patch$2(global) {
	  ...
	  global.addEventListener = function (type, listener, options) {
	    ...
	    listenerMap.set(type, [].concat(toConsumableArray(listeners), [listener]));
	  ...
	  return function free() {
	    listenerMap.forEach(function (listeners, type) {
	      return toConsumableArray(listeners).forEach(function (listener) {
	...
	function patchAtMounting(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
	  ...
	  var patchersInSandbox = (_patchersInSandbox = {}, defineProperty(_patchersInSandbox, exports.SandBoxType.LegacyProxy, [].concat(basePatchers, [function () {
	    return patchLooseSandbox(appName, elementGetter, sandbox.proxy, true, scopedCSS, excludeAssetFilter);
	  }])), defineProperty(_patchersInSandbox, exports.SandBoxType.Proxy, [].concat(basePatchers, [function () {
	    return patchStrictSandbox(appName, elementGetter, sandbox.proxy, true, scopedCSS, excludeAssetFilter);
	  }])), defineProperty(_patchersInSandbox, exports.SandBoxType.Snapshot, [].concat(basePatchers, [function () {
	    return patchLooseSandbox(appName, elementGetter, sandbox.proxy, true, scopedCSS, excludeAssetFilter);
	  }])), _patchersInSandbox);
	...
	function patchAtBootstrapping(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
	  ...
	  var patchersInSandbox = (_patchersInSandbox2 = {}, defineProperty(_patchersInSandbox2, exports.SandBoxType.LegacyProxy, [function () {
	    return patchLooseSandbox(appName, elementGetter, sandbox.proxy, false, scopedCSS, excludeAssetFilter);
	  }]), defineProperty(_patchersInSandbox2, exports.SandBoxType.Proxy, [function () {
	    return patchStrictSandbox(appName, elementGetter, sandbox.proxy, false, scopedCSS, excludeAssetFilter);
	  }]), defineProperty(_patchersInSandbox2, exports.SandBoxType.Snapshot, [function () {
	    return patchLooseSandbox(appName, elementGetter, sandbox.proxy, false, scopedCSS, excludeAssetFilter);
	  }]), _patchersInSandbox2);
	...
	var ProxySandbox = /*#__PURE__*/function () {
	  ...
	  createClass(ProxySandbox, [{
	    ...
	    value: function inactive() {
	      ...
	      {
	        console.info("[qiankun:sandbox] ".concat(this.name, " modified global properties restore..."), toConsumableArray(this.updatedValueSet.keys()));
	      }
	...
	var SnapshotSandbox = /*#__PURE__*/function () {
	  function SnapshotSandbox(name) {
	    classCallCheck(this, SnapshotSandbox);
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                sideEffectsRebuilders = [].concat(toConsumableArray(bootstrappingFreers), toConsumableArray(mountingFreers)).map(function (free) {
	                  return free();
	                });
	                sandbox.inactive();
	...
	function _validateSingularMode() {
	  _validateSingularMode = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(validate, app) {
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	...
	function _loadApp() {
	  _loadApp = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16(app) {
	      ...
	      while (1) {
	        switch (_context16.prev = _context16.next) {
	          case 0:
	            ...
	            _configuration$singul = configuration.singular, singular = _configuration$singul === void 0 ? false : _configuration$singul, _configuration$sandbo = configuration.sandbox, sandbox = _configuration$sandbo === void 0 ? true : _configuration$sandbo, excludeAssetFilter = configuration.excludeAssetFilter, importEntryOpts = objectWithoutProperties(configuration, ["singular", "sandbox", "excludeAssetFilter"]); // get the entry html content and script executor
	          ...
	          case 18:
	            ...
	            useLooseSandbox = _typeof_1(sandbox) === 'object' && !!sandbox.loose;
	          ...
	          case 37:
	            ...
	            parcelConfigGetter = function parcelConfigGetter() {
	              ...
	              var parcelConfig = {
	                name: appInstanceId,
	                bootstrap: bootstrap,
	                mount: [/*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	                  var marks;
	                  return regenerator.wrap(function _callee2$(_context2) {
	                    while (1) {
	                      switch (_context2.prev = _context2.next) {
	                ...
	                asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	                  var useNewContainer;
	                ...
	                asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
	                  ...
	                  var _ref6 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(props) {
	                    return regenerator.wrap(function _callee6$(_context6) {
	                      while (1) {
	                        switch (_context6.prev = _context6.next) {
	                          case 0:
	                            return _context6.abrupt("return", mount(objectSpread2(objectSpread2({}, props), {}, {
	                ...
	                asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
	                ...
	                })), /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8() {
	                ...
	                asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9() {
	                ...
	                })), /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
	                  var measureName;
	                ...
	                unmount: [/*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
	                  ...
	                  var _ref12 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(props) {
	                    return regenerator.wrap(function _callee12$(_context12) {
	                      while (1) {
	                        switch (_context12.prev = _context12.next) {
	                          case 0:
	                            return _context12.abrupt("return", unmount(objectSpread2(objectSpread2({}, props), {}, {
	                              container: appWrapperGetter()
	                            })));
	                ...
	                }(), unmountSandbox, /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
	                ...
	                })), /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
	                ...
	                })), /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15() {
	...
	function prefetch(entry, opts) {
	  ...
	  requestIdleCallback$1( /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	...
	function registerMicroApps(apps, lifeCycles) {
	  ...
	  unregisteredApps.forEach(function (app) {
	    var name = app.name,
	        ...
	        props = app.props,
	        appConfig = objectWithoutProperties(app, ["name", "activeRule", "loader", "props"]);

	    Pt({
	      name: name,
	      app: function () {
	        var _app = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
	            ...
	            while (1) {
	              switch (_context3.prev = _context3.next) {
	                ...
	                case 5:
	                  ...
	                  otherMicroAppConfigs = objectWithoutProperties(_yield$loadApp, ["mount"]);
	                  return _context3.abrupt("return", objectSpread2({
	                    mount: [/*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	                      return regenerator.wrap(function _callee$(_context) {
	                        while (1) {
	                          switch (_context.prev = _context.next) {
	                            case 0:
	                    ...
	                    }))].concat(toConsumableArray(toArray(mount)), [/*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	                      return regenerator.wrap(function _callee2$(_context2) {
	                        while (1) {
	                          switch (_context2.prev = _context2.next) {
	                            case 0:
	...
	function loadMicroApp(app, configuration, lifeCycles) {
	  ...
	  var wrapParcelConfigForRemount = function wrapParcelConfigForRemount(config) {
	    return objectSpread2(objectSpread2({}, config), {}, {
	  ...
	  var memorizedLoadingFn = /*#__PURE__*/function () {
	    var _ref3 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	      ...
	      return regenerator.wrap(function _callee4$(_context4) {
	        while (1) {
	          switch (_context4.prev = _context4.next) {
	            case 0:
	              userConfiguration = configuration !== null && configuration !== void 0 ? configuration : objectSpread2(objectSpread2({}, frameworkConfiguration), {}, {
	                singular: false
	              });
	  ...
	  return C(memorizedLoadingFn, objectSpread2({
	    domElement: document.createElement('div')
	  }, props));
	}
	function start() {
	  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	  frameworkConfiguration = objectSpread2({
	    prefetch: true,
	    singular: true,
	    sandbox: true
	  }, opts);
	  ...
	  var _frameworkConfigurati = frameworkConfiguration,
	      ...
	      importEntryOpts = objectWithoutProperties(_frameworkConfigurati, ["prefetch", "sandbox", "singular", "urlRerouteOnly"]);
	  ...
	  if (sandbox) {
	    if (!window.Proxy) {
	      ...
	      frameworkConfiguration.sandbox = _typeof_1(sandbox) === 'object' ? objectSpread2(objectSpread2({}, sandbox), {}, {
	        loose: true
	      }) : {
	        loose: true
	      };
